...
class Options(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--eta', type=float, default=0.1,
                                 help='coefficient of the KSVD regularization')
        self.parser.add_argument('--low_rank', type=int, default=20,
                                 help='Number of dimension the low rank method projected to')
        self.parser.add_argument('--rank_multi', type=int, default=10,
                                 help='low rank dimension * rank_multi')
        self.parser.add_argument('--nb_features', type=int, default=64,
                                 help='Number of features for the softmax feature maps')
        ...
        self.parser.add_argument('--my_task', type=str, default='pretrain')
        ...
        # Training process
        self.parser.add_argument('--task', choices={"classification"},
                                 default="imputation",
        ...
        # Model
        self.parser.add_argument('--model', type=str, default="primalformer",
                                 help="Model class")
