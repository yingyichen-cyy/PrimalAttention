...
# SelfRegulationSCP2
python main.py --output_dir experiments --comment "classification for Primalformer" --name SelfRegulationSCP2_fromScratch --records_file Classification_records.xls --data_dir Multivariate_ts/SelfRegulationSCP2 --data_class tsra --pattern TRAIN --val_pattern TEST --epochs 100 --lr 0.001 --batch_size 16 --optimizer RAdam  --pos_encoding learnable  --task classification  --key_metric accuracy --model primal_cos --low_rank 20 --eta 0.0 --rank_multi 10

# SpokenArabicDigits
python main.py --output_dir experiments --comment "classification for Primalformer" --name SpokenArabicDigits_fromScratch --records_file Classification_records.xls --data_dir Multivariate_ts/SpokenArabicDigits --data_class tsra  --val_pattern TEST --epochs 100 --lr 0.001 --batch_size 16 --optimizer Adam  --pos_encoding learnable  --task classification  --key_metric accuracy --model primal_cos --low_rank 20 --eta 0.1 --rank_multi 5
