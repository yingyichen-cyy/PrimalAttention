...
import math
import numpy as np
from models.Primalformer import PrimalformerClassiregressor
...
def model_factory(config, data):
    ...
    if (task == "classification") or (task == "regression"):
        ...
        # if config['model'] == 'primalformer':
        return PrimalformerClassiregressor(config['model'], feat_dim, max_seq_len, config['d_model'],
                                            config['num_heads'],
                                            ...
                                            low_rank=config['low_rank'], rank_multi=config['rank_multi'], nb_features=config['nb_features'])
    else:
