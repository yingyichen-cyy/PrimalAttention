...
from fairseq.modules import LayerNorm, MultiheadAttention, PrimalMultiheadAttention
...
class TransformerDecoderLayerBase(nn.Module):
    ...
    *cfg.decoder.normalize_before* to ``True``.
    ...
    def __init__(
        self, cfg, no_encoder_attn=False, primal=False, add_bias_kv=False, add_zero_attn=False
    ):
        super().__init__()
        self.primal = primal
        ...
        if self.primal:
            self.self_attn = self.build_self_primal_attention(
                self.embed_dim,
                cfg,
    ...
    def build_self_primal_attention(
        self, embed_dim, cfg, add_bias_kv=False, add_zero_attn=False
    ):
        return PrimalMultiheadAttention(
            embed_dim,
